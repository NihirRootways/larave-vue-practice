        ...
        <div class="container mx-auto h-full">
            <div class="flex flex-col md:flex-row items-center h-full pt-8">
                <div class="flex-1 flex flex-col items-center lg:items-start">
                    <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Nihir!</p>
                    ...
                    <p class="pt-4 pb-8 md:pb-12 max-w-[480px] text-lg text-center lg:text-left">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit quis ex neque eos amet praesentium possimus saepe labore modi eveniet blanditiis iste tenetur, eius similique, mollitia veritatis maxime consequuntur facilis?
                    </p>
                ...
                <div class="flex flex-1 justify-end items-center h-full md:mt-0">
                    <img class="rounded-lg" src="http://127.0.0.1:8000/img/hero.jpg" alt="Hero">
                </div>
            </div>
        </div>
    </section>

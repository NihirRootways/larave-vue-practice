            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="overflow-x-auto relative">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" v-for="skill in skills.data" :key="skill.id">
                                <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ skill.id }}</th>
                                <td class="py-4 px-6">{{skill.name}}</td>
                                <td class="py-4 px-6"><img :src="skill.image" class="w-12 h-12 rounded-full"/></td>
                                <td class="py-4 px-6">
